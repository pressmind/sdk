...
| `--report` | Generate the verification report after processing (storage scan, derivative statistics, missing-image reset). This is expensive on large buckets and therefore **off by default**. |
