...
class ImageProcessorCommand extends AbstractCommand
{
    ...
    private function hasWorkToDo($image): bool
    {
	        ...
	        if ($this->bucket->supportsPrefixListing()) {
	            $existingFiles = $this->bucket->listByPrefix(WebpSidecar::derivativePrefix($image->file_name));
	        }
    ...
    private function sectionHasWorkToDo(Section $section): bool
    {
	        $existingFiles = null;
	        if ($this->bucket->supportsPrefixListing()) {
	            $existingFiles = $this->bucket->listByPrefix(WebpSidecar::derivativePrefix($section->file_name));
	        }
