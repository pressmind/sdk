...
use Pressmind\ORM\Filter\Output\DoubleFilter;
...
class DoubleFilterTest extends TestCase
{
    ...
    public function testFilterValueConvertsScientificNotation(): void
    {
        $this->assertSame(1.5e3, $this->filter->filterValue('1.5e3'));
    }
